package com.t.cloudmusic.widget.tabLayout;
...
public class XTabLayout extends HorizontalScrollView {
    ...
    public XTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabStrip.setSelectedIndicatorWidth(
                a.getDimensionPixelSize(R.styleable.XTabLayout_x_tabIndicatorWidth, dpToPx(12)));
        ...
        mScrollableTabMinWidth = res.getDimensionPixelSize(R.dimen.design_fab_size_normal);
...
//            child.setMinimumWidth(getTabMinWidth());
    ...
    public final Interpolator FAST_OUT_SLOW_IN_INTERPOLATOR = new FastOutSlowInInterpolator();
